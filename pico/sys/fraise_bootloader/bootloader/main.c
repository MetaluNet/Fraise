...
static inline void fraiseResetTimeout() {
    fraiseTimeout = make_timeout_time_ms(1000);
}
    ...
    if(c == 'V') verifyName(data, len);
        ...
        if(isVerified) {
            ...
            case -3:
                ...
                break;
            default:
                DEBUG("e unrecognized return code from processHexLine()!\n");
            }
        }
